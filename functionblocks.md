...
## 日本語仕様の拡張機能と利用方法
### 日本語仕様の概要
BME280　日本語仕様拡張機能はmicroPhython Chineseコミュニティの拡張機能をベースに開発しました。拡張機能そのものは、ほぼmicroPhython Chineseコミュニティのものと同じです。ただし、ブロック表記の日本語化に加え次の機能を加えました。
...
### 利用方法
micro:bitのMakeCode %trade; （以下MakeCodeと表記）のエディター画面から拡張機能をクリックし下のURLを拡張機能の検索に張り付けてください。 
